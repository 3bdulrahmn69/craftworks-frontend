    ...
    return (
      <Container>
        <div
          ...
          role="status"
          aria-label="Loading available jobs"
        >
          <div className="text-lg">Loading jobs...</div>
          <span className="sr-only">
            Please wait while we load available jobs for you.
          </span>
        </div>
      </Container>
    );
  ...
  return (
    <Container className="py-8">
      <main role="main">
        ...
        {error && (
          <div
            className="bg-destructive/10 border border-destructive/20 text-destructive px-6 py-4 rounded-xl mb-6"
            role="alert"
            aria-live="polite"
          >
