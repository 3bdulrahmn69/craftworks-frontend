...
import { IoPerson, IoLogOut, IoSettings } from 'react-icons/io5';
...
const UserMenu = () => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {/* Dropdown Menu */}
      {open && (
        <div className="absolute right-0 mt-3 w-64 sm:w-72 bg-card border border-border rounded-xl shadow-xl z-50 animate-fadeIn duration-200 md:right-0 sm:right-0 max-w-[calc(100vw-2rem)]">
          {/* User Info Header */}
          ...
          <div className="p-2">
            ...
            >
              <IoLogOut className="w-4 h-4 text-muted-foreground group-hover:text-destructive transition-colors flex-shrink-0" />
