  ...
  const testimonials = [
    {
      ...
      content: t('testimonials.testimonial1.content', 'Found an excellent electrician through this platform. Professional, punctual, and did a fantastic job with my home wiring. Highly recommend!'),
      rating: 5,
      avatar: 'SA'
    },
    {
      ...
      content: t('testimonials.testimonial2.content', 'This platform has helped me find consistent work and build my client base. The payment system is secure and the support team is very helpful.'),
      rating: 5,
      avatar: 'MH'
    },
    {
      ...
      content: t('testimonials.testimonial3.content', 'I needed urgent plumbing repairs for my restaurant. Found a reliable plumber within hours and the work was completed professionally.'),
      rating: 5,
      avatar: 'FA'
    }
  ];
      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            {t('testimonials.subtitle', 'Join thousands of satisfied clients and craftsmen who trust our platform for their projects.')}
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                {t('testimonials.trust.verified.description', 'All craftsmen are verified and background-checked for your safety')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                {t('testimonials.trust.secure.description', 'Your payments are protected with bank-level security')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                {t('testimonials.trust.support.description', 'Our support team is always here to help you')}
              </p>
            </div>
          </div>
        </div>
